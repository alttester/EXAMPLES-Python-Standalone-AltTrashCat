...
class GamePlayPage(BasePage):
    ...
    def avoid_obstacles(self, number_of_obstacles=10):
        ...
        for i in range(0, number_of_obstacles):
            all_obstacles_unsorted = self.altdriver.find_objects(By.PATH,"//*[contains(@name,Obstacle)]")
            ...
            print("OBSTACLE: " + str(obstacle.name) + ", z:" + str(obstacle.worldZ) + ", x:" + str(obstacle.worldX))
            print("NEXT: " + str(obstacles[1].name) + ", z:" + str(obstacles[1].worldZ) + ", x:" + str(obstacles[1].worldX))
